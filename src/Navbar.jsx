	...
	render() {
		...
		return(
			<header>
				<h1>RecipeApp</h1>
				{recipesLeft > 0
					? <div className="wrapper"><h4>Recipes left: <span id="recipes-left-number" title="Recipes are limited because browsers limit local storage.">{recipesLeft}</span></h4></div>
